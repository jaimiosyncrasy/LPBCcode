...
%     Turn controllers off because collecting step response data   
...
%%
    ...
    % Run simulink
        ...
        sim('sunny2_RCAC.mdl')
        set_param('sunny2_RCAC','AlgebraicLoopSolver','LineSearch'); % so that derivative term in discrete PID controller doesn't have error
