...
% read initialization file
    testIdx=20; % TEMP (sim1_1 = 2; sim_9 = 3), for each scenario run, first test below the headers is idx=1
...
title('P-->Vang');
    ...
    figure;
    ax1=subplot(2,2,1);
    plot(itvl-65,-testDbcData(itvl,1*2+1)+210,'LineWidth',1.5);
    ax3=subplot(2,2,3);
    ...
    figure;
    ax1=subplot(2,1,1);
    plot(itvl-65,-testDbcData(itvl,1*2+1)+210,t,stepCurve,'LineWidth',1.5); legend('real','controller model'); title('step dbc');
    ax3=subplot(2,1,2);
    plot(itvl-65,vmag_new(itvl,1)-0.9725,t,y,'LineWidth',1.5); legend('real','controller model'); title('response step');
