function [vmag_ref,vang_ref,p_init,q_init,vmag_init_actual, vang_init_actual]  = set_const_target(minStart,minEnd,Sbase,meas_idx,measStr,controlLoopAlign,test_num) 
    ...
    [tarVmag,tarVang,Vang_nom] = process_targets(minStart,controlLoopAlign,measStr,meas_idx,test_num)
