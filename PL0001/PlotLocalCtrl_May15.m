...
%put in for loop if want diff control gains for diff nodes
    ...
    hold on;
    plot(tidx(inter+1),qnew(tidx(inter+1),plotIdx(1)),'r-','LineWidth',2);
    plot(tidx(inter+1),qnew(tidx(inter+1),plotIdx(2)),'b-','LineWidth',2);
    plot(tidx(inter+1),qnew(tidx(inter+1),plotIdx(3)),'color',[0.9290 0.6940 0.1250],'LineWidth',2);
...
%% Plot outputs v
    figure;     % same plot across phases
    hold on;
    plot(tidx(inter+1),vmag_new(tidx(inter+1),plotIdx(1)),'r-',tidx(inter+1),vmag_ref_sig(tidx(inter+1),1),'r-.','LineWidth',2);
    plot(tidx(inter+1),vmag_new(tidx(inter+1),plotIdx(2)),'b-',tidx(inter+1),vmag_ref_sig(tidx(inter+1),2),'b-.','LineWidth',2);
    plot(tidx(inter+1),vmag_new(tidx(inter+1),plotIdx(3)),tidx(inter+1),vmag_ref_sig(tidx(inter+1),3),'-.','color',[0.9290 0.6940 0.1250],'LineWidth',2);
    r=tidx(inter+1);
    Ts_bound=0.02;
...
% Plot inverter commands pnew
    figure;     % same plot across phases
    hold on;
    plot(tidx(inter+1),pnew(tidx(inter+1),plotIdx(1)),'r-','LineWidth',2);
    plot(tidx(inter+1),pnew(tidx(inter+1),plotIdx(2)),'b-','LineWidth',2);
    plot(tidx(inter+1),pnew(tidx(inter+1),plotIdx(3)),'color',[0.9290 0.6940 0.1250],'LineWidth',2);
...
%% Plot vang as subplots so can see up close:
    ...
    plot(tidx(inter+1),vang_new(tidx(inter+1),plotIdx(1)),'r-',tidx(inter+1),vang_ref_sig(tidx(inter+1),1),'r-.','LineWidth',2);
    plot([Vang_ctrlStart/Ts,Vang_ctrlStart/Ts],get(gca,'ylim'),'k-');
    ...
    plot(tidx(inter+1),vang_new(tidx(inter+1),plotIdx(2)),'b-',tidx(inter+1),vang_ref_sig(tidx(inter+1),2),'b-.','LineWidth',2);
    plot([Vang_ctrlStart/Ts,Vang_ctrlStart/Ts],get(gca,'ylim'),'k-');
    ...
    plot(tidx(inter+1),vang_new(tidx(inter+1),plotIdx(3)),tidx(inter+1),vang_ref_sig(tidx(inter+1),3),'-.','color',[0.9290 0.6940 0.1250],'LineWidth',2);
    plot([Vang_ctrlStart/Ts,Vang_ctrlStart/Ts],get(gca,'ylim'),'k-');
...
qinv(6000,:)% check that all are below sat point
pinv(6000,:) 